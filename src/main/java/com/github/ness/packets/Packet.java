...
public class Packet {
    ...
    public Packet(final Direction direction, final Object rawPacket, final byte packetId) {
    ...
    public boolean isWindowClick() {
        return isReceiving() && packetId == PacketType.Client.WINDOW_CLICK;
    }
    ...
    public boolean isCloseWindow() {
        return isReceiving() && packetId == PacketType.Client.CLOSE_WINDOW;
    }

    public boolean isKeepAlive() {
        return isReceiving() && packetId == PacketType.Client.KEEP_ALIVE;
    }
    ...
    public boolean isCustomPayload() {
        return isReceiving() && packetId == PacketType.Client.CUSTOM_PAYLOAD;
    }
