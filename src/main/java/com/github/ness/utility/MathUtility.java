...
public class MathUtility {
	...
	/**
	 * The value of the golden ratio. The golden ratio is defined to be the value
	 * &phi; such that:
	 *
	 * <blockquote> &phi; = (&phi; + 1) / &phi; </blockquote>
	 *
	 * Note that this is a quadratic equation (multiply both sides by &phi;) with
	 * the solution roughly <code>1.61803399</code>.
	 *
	 * <p>
	 * See the following for a fascinating tour of the properties of the golden
	 * ratio:
	 *
	 * <ul>
	 * <li><a href="http://mathworld.wolfram.com/GoldenRatio.html" >Mathworld:
	 * Golden Ratio</a></li>
	 * </ul>
	 */
	...
	/**
	 * An array of the Fibonacci sequence up the maximum value representable as a
	 * long integer. The array is defined as follows:
	 *
	 * <blockquote>
	 * 
	 * <pre>
	 ...
	 * </blockquote>
	 *
	 * So <code>FIBONACCI_SEQUENCE[0]</code> represents the second Fibonacci number
	 * in the traditional numbering. The inital entries are:
	 *
	 * <blockquote><code>
	 ...
	 *
	 * <P>
	 * See the following references for more information on the fascinating
	 * properties of Fibonacci numbers:
	 *
	 * <UL>
	 * <LI><a href="http://en.wikipedia.org/wiki/Fibonacci_number">Wikipedia:
	 * Fibonacci Number</a>
	 * <LI><a href="http://mathworld.wolfram.com/FibonacciNumber.html">Mathworld:
	 * Fibonacci Number</a>
	 */
	public static final long[] FIBONACCI_SEQUENCE = new long[] { 1l, 2l, 3l, 5l, 8l, 13l, 21l, 34l, 55l, 89l, 144l,
			233l, 377l, 610l, 987l, 1597l, 2584l, 4181l, 6765l, 10946l, 17711l, 28657l, 46368l, 75025l, 121393l,
			196418l, 317811l, 514229l, 832040l, 1346269l, 2178309l, 3524578l, 5702887l, 9227465l, 14930352l, 24157817l,
	...
	/**
	 * Returns <code>true</code> if the specified number is prime. A prime is a
	 * positive number greater than <code>1</code> with no divisors other than
	 * <code>1</code> and itself, thus <code>{2,3,5,7,11,13,...}</code>.
	 *
	...
	/**
	 * Returns the smallest prime number that is strictly larger than the specified
	 * integer. See {@link #isPrime(int)} for the definition of primality.
	 *
	 * @param num Base from which to look for the next prime.
	 * @return Smallest prime number strictly larget than specified number.
	 */
	...
	/**
	 * Converts a natural logarithm to a base 2 logarithm. This inverts the
	 * operation of {@link #logBase2ToNaturalLog(double)}.
	 * 
	 * <p>
	 * If the input is <code><i>x</i> = ln <i>z</i></code>, then the return value is
	 * <code>log<sub>2</sub> <i>z</i></code>. Recall that <code>log<sub>2</sub>
	 * <i>z</i> = ln <i>z</i> / ln 2.
	 *
	 ...
	 * The computation is carried out by subtracting the minimum value, as defined
	 * by the constant {@link Byte#MIN_VALUE}.
	 *
	...
	/**
	 * Returns the log (base 2) of the factorial of the specified long integer. The
	 * factorial of <code>n</code> is defined for <code>n > 0</code> by:
	 *
	 * <blockquote><code>
	 *  n!
	...
	/**
	 * Returns the minimum of the specified array of double values. If the length of
	 * the array is zero, the result is {@link Double#NaN}.
	 *
	...
	/**
	 * Returns the maximum of the specified array of double values. If the length of
	 * the array is zero, the result is {@link Double#NaN}.
	 *
	 * @param xs Variable length list of values, or an array.
	...
	/**
	 * Returns the log (base 2) of the binomial coefficient of the specified
	 * arguments. The binomial coefficient is equal to the number of ways to choose
	 * a subset of size <code>m</code> from a set of <code>n</code> objects, which
	 * is pronounced "n choose m", and is given by:
	 *
	 * <blockquote><code>
	 *   choose(n,m) = n! / ( m! * (n-m)!)
	 *   <br>
	 ...
	 * </code></blockquote>
	 *
	 * @return The log (base 2) of the binomial coefficient of the specified
	 *         arguments.
	 */
	...
	static double[] LANCZOS_COEFFS = new double[] { 0.99999999999980993, 676.5203681218851, -1259.1392167224028,
	 ...
	 *
	 * <p>
	 * The digamma function is the derivative of the log of the gamma function; see
	 * the method documentation for {@link #log2Gamma(double)} for more information
	 * on the gamma function itself.
	 *
	 * <blockquote>
	 * 
	 * <pre>
	 ...
	 * <a href="http://arxiv.org/abs/math/0403344">Chebyshev Series Expansion of
	 * Inverse Polynomials</a>.
	 * <li>
	 * <li>Richard J. Mathar. 2005. <a href=
	 * "http://www.strw.leidenuniv.nl/~mathar/progs/digamma.c">digamma.c</a>. (C
	 * Program implementing algorithm.)</li>
	 * </ul>
	 *
	 * <i>Implementation Note:</i> The recursive calls in the C implementation have
	 * been transformed into loops and accumulators, and the recursion for values
	 * greater than three replaced with a simpler reduction. The number of loops
	 * required before the fixed length expansion is approximately integer value of
	 * the absolute value of the input. Each loop requires a floating point
	 * division, two additions and a local variable assignment. The fixed portion of
	 * the algorithm is roughly 30 steps requiring four multiplications, three
	 * additions, one static final array lookup, and four assignments per loop
	 * iteration.
	 *
	...
	/**
	 * This method returns the log of the sum of the natural exponentiated values in
	 * the specified array. Mathematically, the result is
	 *
	 * <blockquote>
	 * 
	 * <pre>
	 ...
	 * </blockquote>
	 *
	 * But the result is not calculated directly. Instead, the calculation performed
	 * is:
	 *
	 * <blockquote>
	 * 
	 ...
	 * because the largest value for which <code>exp()</code> is calculated is 0.0.
	 *
	 * <p>
	 * Values of {@code Double.NEGATIVE_INFINITY} are treated as having exponentials
	 * of 0 and logs of negative infinity. That is, they are ignored for the
	 ...
	 * @throws ArrayIndexOutOfBoundsException If the specified array does not contai
	...
	/**
	 * Returns the sum of the specified integer array. Note that there is no check
	 * for overflow. If the array is of length 0, the sum is defined to be 0.
	 *
